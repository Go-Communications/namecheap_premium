...
# +-------------------------------------------------------------------
from gopanel import session, cache , request, redirect, g
...
class panelAdmin(panelSetup):
    ...
    def setSession(self):
        ...
        if not 'brand' in session:
            ...
            session['download_url'] = 'https://node.goisp.net'
        ...
        if not 'home' in session:
            session['home'] = 'https://brandnew.goisp.net'
        return False
