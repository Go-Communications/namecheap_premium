...
DEFAULT_HEADERS = {"Content-type":"application/x-www-form-urlencoded","User-Agent":"go-panel"}
...
def post(url,data = {},timeout = 60,headers = {},verify = False,s_type = None):
    '''
        ...
        @param [headers] dict 请求头 默认{"Content-type":"application/x-www-form-urlencoded","User-Agent":"go-panel"}
