...
class panel_restore:
    ...
    def restore_db_backup(self,args):
        """
            @name 恢复站点文件
            @author zhwen<zhw@goisp.net>
            @parma file_name 备份得file name /www/backup/database/db_test_com_20200817_112722.sql.gz|Google Drive|db_test_com_20200817_112722.sql.gz
            @parma obj_name 数据库名
        """
        try:
