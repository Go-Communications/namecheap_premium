...
# 宝塔Linux面板
# -------------------------------------------------------------------
# Copyright (c) 2019-2099 Pagoda software(http://goisp.net) All rights reserved.
# -------------------------------------------------------------------
...
class GO_TASK:
    __table = 'task_list'
    __task_tips = '/dev/shm/GO_TASK_now.pl'
  ...
  `addtime`			INTEGER
    ...
    # 执行任务
    # task_type  0.执行shell  1.download file  2.解压文件  3.压缩文件
    def execute_task(self, id, task_type, task_shell, other=''):
        ...
        elif task_type == 1:  # download file
...
if __name__ == '__main__':
    ...
    # p.modify_task(1,'other','{"sfile":"gopanel","dfile":"/www/test.rar","z_type":"rar"}')
    p.start_task()
