...
{
    listen 80;
    server_name huang.goisp.net bt001.goisp.net;
    index index.php index.html index.htm default.php default.htm default.html;
    root /www/wwwroot/huang.goisp.net;
    ...
    include /www/server/panel/vhost/rewrite/huang.goisp.net.conf;
    #REWRITE-END
    ...
    access_log  /www/wwwlogs/huang.goisp.net.log;
    error_log  /www/wwwlogs/huang.goisp.net.error.log;
};'''
    ...
    def _generate_nginx_conf(self,siteName):
        ...
        siteConfig = {
	                    ...
	                    "antiStealingLink": {
		                    ...
		                    "domains": ["www.goisp.net", "goisp.net"],
		                    "code": 404
	                    },
	                    "networkLimit": {
		                    "open": False,
