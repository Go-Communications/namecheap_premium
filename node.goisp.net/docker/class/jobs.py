...
def files_set_mode():
    ...
    m_paths = [
        ...
        ["/www/server/panel/gopanel","","root",600,True],
        ...
        ["/www/server/panel/go-panel","","root",700,False],
        ["/www/server/panel/go-task","","root",700,False],
...
def run_new():
    try:
        ...
        if cmd_line.find('go-panel') != -1: return False
