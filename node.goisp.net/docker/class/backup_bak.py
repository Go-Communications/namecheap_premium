...
class backup_bak:
    ...
    def backup_database_data(self,id):
        ...
        if not os.path.exists('/www/server/panel/gopanel/static' + '/database'): public.ExecShell(
            'mkdir -p ' + '/www/server/panel/gopanel/static' + '/database');
        ...
        backupName = '/www/server/panel/gopanel/static'+ '/database/' + fileName
    ...
    def backup_site_data(self,id):
        ...
        backupPath = '/www/server/panel/gopanel/static'+ '/site'
    ...
    def backup_path(self,path):
        ...
        backupPath = '/www/server/panel/gopanel/static'+ '/path'
        zipName = backupPath + '/'+fileName
        if not (os.path.exists(backupPath)): os.makedirs(backupPath)
        tmps = '/tmp/panelExec.log'
