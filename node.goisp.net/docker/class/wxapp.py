...
import json
import time
from gopanel import session,cache,request
...
class wxapp():
    ...
    def login_qrcode(self, get):
        ...
        qrcode_str = 'https://app.goisp.net/app.html?&panel_url='+public.getPanelAddr()+'&v=' + public.GetRandomString(3)+'?login&tid=' + tid
    ...
    def check_app_login(self,get):
        ...
        try:
            ...
            public.login_send_body("gopanel Mobile",userInfo['username'],public.GetClientIp(),str(request.environ.get('REMOTE_PORT')))
