...
var index = {
    ...
    get_init: function () {
        ...
        setTimeout(function () {
            bt.system.check_update(function (rdata) {
                ...
                //     $('#btversion').append('<a class="btlink" href="https://www.goisp.net/bbs/forum-39-1.html" target="_blank">  ['+lan.index.find_bug_reward+']</a>');
                // }
    ...
    */
    ...
    open_log: function () {
        ...
        $.get('https://www.goisp.net/Api/getUpdateLogs?type=' + bt.os, function (rdata) {
            var body = '';
