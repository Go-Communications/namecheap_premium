	...
	layer.open({
		...
		content: '<div class="bt-form pd20 pd70" style="padding:20px 35px;">\
                ...
                <div class="details" style="margin-top:5px;padding-left: 3px;">\
					...
					<label style="font-weight: 400;margin: 3px 5px 0px;" for="check_port">I already understand</label>,<a target="_blank" class="btlink" href="https://forum.goisp.net/d/599-how-to-release-the-gopanel-port">How to release the port?</a>\
				</div>\
			</div>',
		...
		layer.open({
			...
			content: '<div class="bt-form pd20 pd70 ssl_cert_from google_verify" style="padding:20px 35px;">\
				...
				<div class="details" style="width: 90%;margin-bottom:10px;">\
					...
					<a target="_blank" class="btlink" href="https://forum.goisp.net/d/357-how-to-use-google-authenticator-in-the-gopanel">Learn more</a>\
				</div>\
	...
	layer.open({
        ...
        content: '<div class="bt-form pd20" style="padding:20px 35px;">\
					...
					<div class="verify_tips">\
						<p>Tips: Please use the "Google Authenticator APP" binding to support Android, IOS system.<a href="https://forum.goisp.net/d/357-how-to-use-google-authenticator-in-the-gopanel" class="btlink" target="_blank">Use tutorial</a></p>\
									...
									html: '\
											<div style="position: relative; width: 90%; margin: 0 auto;">\
													...
													<ul style="width: 100%;">\
															...
															<li>If panel is not accessible, you can click the <a class="btlink" href="https://forum.goisp.net/d/167-common-problems-after-opening-the-panel-certificate" target="_blank">link</a> below to find solutions</li>\
													</ul>\
											</div>\
									'
							},
							...
							},
							{
									html: '\
											<div class="details" style="width: 80%;">\
													...
													<a class="btlink" style="top: 0;" href="https://forum.goisp.net/d/167-common-problems-after-opening-the-panel-certificate" target="_blank">' + lan.config.ssl_open_ps_5 + '</a>\
											</div>\
									'
							}
	...
	$.post('/config?action=GetPanelSSL',{},function(cert){
		...
		var certBody = '<div class="tab-con">\
			...
			<ul class="help-info-text c7 pull-left">\
				<li>'+lan.config.ps+'<a href="http://www.goisp.net/bbs/thread-704-1-1.html" class="btlink" target="_blank">['+lan.config.help+']</a>。</li>\
	...
	var rhtml = '<div class="boxConter" style="display: none">\
					<div class="iconCode" >\
						<div class="box-conter">\
							...
							<div class="codeTip">\
								<ul>\
									<li>1、'+lan.config.open_small_app+'<span class="btlink weChat">'+lan.config.qrcore_of_small_app+'<div class="weChatSamll"><img src="https://app.goisp.net/static/app.png"></div></span></li>\
        ...
        layer.open({
			...
			content: ' <div class="bt-form bt-form" style="padding:15px 25px">\
                        ...
                        <ul class="help-info-text c7">\
                            ...
                            <li>'+lan.config.help3+'：<a class="btlink" href="https://forum.goisp.net/d/482-api-interface-tutorial" target="_blank">https://forum.goisp.net/d/482-api-interface-tutorial</a></li>\
                        </ul>\
                    </div>'
        })
    });
    ...
    $.post('/config?action=get_basic_auth_stat', {}, function (rdata) {
        ...
        if (rdata.open) {
            ...
            m_html = '<div class="risk_form"><i class="layui-layer-ico layui-layer-ico3"></i>'
                ...
                + '<a target="_blank" style="font-size:12px;" class="btlink" href="https://www.goisp.net/bbs/thread-34374-1-1.html">What is BasicAuth authentication?</a><p></p></div>'
