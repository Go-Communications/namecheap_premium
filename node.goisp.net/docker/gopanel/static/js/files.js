var bt_file = {
    ...
    */
    ...
    data_reconstruction:function(data,type,callback){
        var that = this,arry = [],info_ps = [
            ...
            ['/www','PS: gopanel program directory'],
            ...
            ['/www/server','PS: gopanel soft installed directory'],
            ['/www/wwwlogs','PS: Site logs directory'],
            ['/www/Recycle_bin',lan.files.recycle_bin_dir],
            ['/www/server/panel','PS: gopanel main program directory, do not move'],
            ['/www/server/panel/plugin','PS: gopanel plugin directory'],
            ['/www/server/panel/gopanel','PS: gopanel directory'],
            ['/www/server/panel/gopanel/static','PS: gopanel static directory'],
            ['/www/server/panel/gopanel/templates','PS: gopanel templates directory'],
    ...
    */
     ...
     * @param {String} _filename     file name称
     * @return: 无返回值
     */
    ...
    */
    ...
    /**
     * @description 获取路径上的file name称
     * @param {String} path 路径
     * @return {String} file name称
     */
    ...
    compress_file_or_dir:function(data,isbatch){
        ...
        this.reader_form_line({
            ...
            beforeSend:function(updata){
                var ind = data.path.lastIndexOf("\/"),_url = data.path.substring(0,ind+1);  // 过滤路径file name
