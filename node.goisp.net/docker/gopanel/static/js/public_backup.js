        ...
        var rhtml = '<div class="boxConter" style="display: none">\
								<div class="iconCode" >\
									<div class="box-conter">\
										...
										<div class="codeTip">\
											<ul>\
												<li>1、' + lan.public_backup.open_bt_small_app + '<span class="btlink weChat">' + lan.public_backup.app_qr_core + '<div class="weChatSamll"><img src="https://app.goisp.net/static/app.png"></div></span></li>\
        ...
        bt.send('GetPanelSSL', 'config/GetPanelSSL', {}, function(cert) {
            ...
            var certBody = '<div class="tab-con">\
				...
				<ul class="help-info-text c7 pull-left">\
					<li>' + lan.public_backup.cret_help + '<a href="http://www.goisp.net/bbs/thread-704-1-1.html" class="btlink" target="_blank">[' + lan.public_backup.help + ']</a>。</li>\
...
bt.soft = {
    ...
    if(config.renew === -1) config.renew = false
        ...
        var arry = [];
				...
				// }
				// if(config.type == 12 && config.pro >= 0 && config.ltd < 0) $('.pro-tips').html('温馨提示：专业版升级企业版需要手动结算当前专业版授权，<a href="https://www.goisp.net/bbs/thread-50342-1-1.html" target="_blank" class="btlink">《专业版和企业版切换教程》</a>').css('color','red');
    ...
    */
	...
	// 				</div>\
	// 				<p style="position:absolute;bottom:17px;left:0;width:100%;text-align:center;color:red">' + lan.public_backup.buy_multiplev_bt_pro + '<a class="btlink" href="https://www.goisp.net/download/linuxpro.html#price" target="_blank">' + lan.public_backup.goto_bt + '</a></p>\
	// 			</div>';
    ...
    bt.send('get_cert_source', 'config/get_cert_source', {}, function (rdata) {
        ...
        var _data = {
            ...
            list: [
              ...
              {
              	html:'<div class="details"><input type="checkbox" id="checkSSL" /><label style="font-weight: 400;margin: 3px 5px 0px;" for="checkSSL">'+lan.config.ssl_open_ps_4+'</label><a target="_blank" class="btlink" href="https://forum.goisp.net/d/167-common-problems-after-opening-the-panel-certificate">'+lan.config.ssl_open_ps_5+'</a></p></div>'
              }
