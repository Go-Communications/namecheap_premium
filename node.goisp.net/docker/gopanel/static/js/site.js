                ...
                if (auth_type == 'dns' && res.status === 'pending') {
                    ...
                    setTimeout(function() {
                        ...
                        $('.div_txt_jx').append(bt.render_help([
                            ...
                            'If you are using Goisp Cloud Resolution Plugin, Alibaba Cloud DNS, DnsPod as DNS, you can use the DNS interface to automatically resolve'
                        ]));
                    });
                    return;
                }
                                    ...
                                    var load_form = bt.open({
                                        ...
                                        success:function(){
                                            ...
                                            for (var i = 0; i < datas.length; i++) {
                                                ...
                                                var _other = (bt.os == 'Linux' && i == 0) ? '<span>Rewrite rule converter：<a href="https://www.goisp.net/Tools" target="_blank" style="color:#20a53a">Apache to Nginx</a></span>' : '';
        ...
        get_rewrite_list: function(web) {
            ...
            bt.site.get_rewrite_list(web.name, function(rdata) {
                ...
                for (var i = 0; i < datas.length; i++) {
                    var _form_data = bt.render_form_line(datas[i]);
                    _html.append(_form_data.html);
                    var _other = (bt.os == 'Linux' && i == 0) ? '<span>' + lan.site.rewrite_change_tools + '：<a href="https://www.goisp.net/Tools" target="_blank" style="color:#20a53a">' + lan.site.ap_change_ng + '</a></span>' : '';
                    _html.find('.info-r').append(_other)
                    clicks = clicks.concat(_form_data.clicks);
                }
    ...
    set_ssl: function(web) {
        ...
        bt.site.get_site_ssl(web.name, function(rdata) {
            var _tabs = [
                ...
                //                                     window.open('https://www.goisp.net/register.html')
                //                                 }
                //                             }
                //                         ]
                //                     }
                                                        ...
                                                        callback: function(obj) {
                                                            ...
                                                            if (_val_obj.data !== false) {
                                                                ...
                                                                if(_val_obj.help == "How to get API Token"){
                                                                    _val_obj.help = '<a class="btlink"  target="_blank" href="https://forum.goisp.net/d/3375-3375-set-the-clouldflare-apt-token-for-dns-editing-permissions">'+_val_obj.help+"</a>"
                                                                }
