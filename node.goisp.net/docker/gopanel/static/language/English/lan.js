var lan = {
	...
	"index":{
		...
		"bind_bt_account_first":"Please bind your gopanel account first!",
		...
		"update":"Update",
		"find_bug_reward":"Find bugs, get gopanel coins",
	...
	"config":{
		...
		"config_user_binding":"Binding your gopanel account",
		"config_user_edit":"Change gopanel account",
		"binding":"Bind",
		"token_get":"Getting token...",
		"user_bt":"Username",
		"pass_bt":"Password",
		"binding_un_msg":"Are you sure to unbind gopanel account？",
		...
		"open_small_app":"Open the gopanel panel Mini Program",
		"qrcore_of_small_app":"QR code of Mini Program",
		"scan_qrcore_with_small_app":"Use gopanel Mobile to scan the current QR code to bind the panel",
		"return_bind_list":"Return to the panel binding list",
		"read_bind_list":"View binding list",
		"bind_wechat":"Bind WeChat",
		"no_bind_bt_account":"gopanel account NOT bound",
	...
	"firewall":{
		...
		"bt_default_port":"Default port of gopanel",
	...
	"bt":{
		...
		"panel_add":"Add gopanel association",
	...
	"files":{
		...
		"swap_file":"PS: SWAP swap partition file set by default by gopanel",
		...
		"ps_swap":"PS: gopanel default swap virtual RAM file",
		...
		"upload_files_tips1":"PS: gopanel file upload temporary file, re-upload resume from breakpoint, can be deleted",
	...
	"soft":{
		...
		"bt_developer":"Security Reminder: gopanel officially conducted a security audit before the third-party plug-in was put on the shelves, but there may be security risks. Please check it out before using it in the production environment.",
		...
		"author":"Author",
		"source":"Source",
		"third_party_apps_tips1":"This is a plugin developed by a third party, gopanel can not verify its reliability!",
	...
	"site":{
		...
		"bt_bind_no":"Not bound to gopanel account, please register and bind. After binding gopanel account (non-forum account), you can deploy SSL with one click",
		"bt_user":"gopanel Account",
		"bt_user_first":"Account",
		"login":"Login",
		"bt_reg":"Register gopanel account",
		"bt_ssl_help_1":"gopanel SSL certificate is issued by TrustAsia, requires real name identification",
		"bt_ssl_help_2":"If you have gopanel account, please log in and bind it",
		"bt_ssl_help_3":"gopanel SSL applys certificate TrustAsia DV SSL CA - G5. Original price: 1900 RMB/year, but free for gopanel users!",
		...
		"bt_ssl_help_6":"gopanel SSL certificate is the free version of TrustAsia DV SSL CA - G5 certificate, which only supports a single domain.",
		...
		"bt_ssl_help_10":"Paste you KEY and CRT content, and then save it<a href='http://www.goisp.net/bbs/thread-704-1-1.html' class='btlink' target='_blank'>[HELP]</a>。",
        ...
        "ssl_tips2": "gopanel SSL applys for the free version of TrustAsia DV SSL CA - G5 certificate, which only supports single domain name application.",
        ...
        "ssl_tips6": "99% of users can easily deploy themselves, if you don't understand, <a class='btlink' href='https://www.goisp.net/yunwei' target='_blank'>gopanel provides certificate deployment service 50 yuan Once</a>",
        ...
        "dns_check_tips3": "Before using the [gopanel DNS Cloud Resolution] API, you need to confirm that the domain DNS for which you want to apply for SSL certificate is [Cloud Resolution]",
        ...
        "dns_resolve_tips2": "Domain resolution can be manually verified by the CMD command: nslookup-q=txt _ acme-challenge.goisp.net",
        "dns_resolve_tips3": "If you are using the gopanel Cloud Resolution plugin, Ali Cloud DNS,DNSPod as a DNS, you can set auto-resolution with the DNS API",
		...
		"add_site":{
			...
			"bath_tips8":"Eq, goisp.net,test.cn:8081|/www/wwwroot/goisp.net|1|1|56",
	...
	"public_backup":{
		...
		"cp_success":"Successfully copied",
		"cp_fail":"Failed to copy, browser is not compatible!",
		"bind_bt_account":"Bind gopanel account",
		...
		"cancel":"Cancel",
		"unbind":"Unbind",
		"open_bt_small_app":"Open the gopanel panel mini program",
		"app_qr_core":"Mini program QR code",
		"scan_qr_core":"Use gopanel Mobile to scan the current QR code and bind to the panel",
		...
		"year3":"3 years",
		"permanent":"Permanent",
		"buy_multiplev_bt_pro":"Note: If you need to purchase multiple permanent licenses, please visit the gopanel official site to purchase",
		"goto_bt":"Go to gopanel official site",
	...
	"login":{
		"qr_core_login":"gopanel Mobile QR code login",
		"open":"Open",
		"bt_small_p":"gopanel Mobile",
	...
	"webhook":{
		...
		"read_key":"View key",
		"test":"Test",
		"use_method":"How to use gopanel WebHook:",
