var lan = {
	...
	"config": {
		...
		"config_user_binding": "Binding go-panel Account",
		"config_user_edit": "Change go-panel Account",
		"binding": "Bind",
		"token_get": "Obtaining Private key...",
		"user_bt": "go-panel User Name",
		"pass_bt": "go-panel Password",
		"binding_un_msg": "Are you sure to unbind go-panel Account？",
		...
		"open_small_app": "Open the Goisp panel applet",
		"qrcore_of_small_app": "Small program QR code",
		"scan_qrcore_with_small_app": "Use the Goisp applet to scan the current QR code and bind the panel",
		"return_bind_list": "Return panel binding list",
		"read_bind_list": "View binding list",
		"bind_wechat": "Bind WeChat",
		"no_bind_bt_account": "Unbound Goisp account",
	...
	"firewall": {
		...
		"bt_default_port": "gopanel Linux panel default port",
		"del": "Del",
		"number": "Numbering",
		"behavior": "behavior",
		"status": "Status",
	...
	"bt": {
		...
		"panel_add": "Associate to go-panel",
	...
	"files": {
		...
		"ps_swap": "PS: SWAP swap partition file set by default in gopanel",
	...
	"soft": {
		...
		"bt_developer": "The Goisp Developer Platform has been launched, and we invite high-quality developers from all over the world to join, with low thresholds and high income.",
		...
		"author": "author",
		"source": "source",
		"third_party_apps_tips1": "This is a plug-in developed by a third party, and the Goisp cannot verify its reliability!",
	...
	"site": {
		...
		"ssl_close": "Close SSL",
		"bt_bind_no": "Does not bind go-panel account, please create new account, and bind go-panel account to apply one-click deployment of SSL",
		"bt_user": "go-panel Account",
		"login": "Login",
		"bt_reg": "Register go-panel account",
		"bt_ssl_help_1": "go-panel SSL Certificate is issued by TrustAsia, requires real name identification",
		"bt_ssl_help_2": "If you have go-panel account, please bind it after login",
		"bt_ssl_help_3": "go-panel SSL applys certificate TrustAsia DV SSL CA - G5. Original price: 1900 RMB/year, free for go-panel users!",
		...
		"bt_ssl_help_6": "go-panel SSL certificate is the free version of TrustAsia DV SSL CA - G5 certificate, which only supports a single domain.",
		...
		"ssl_tips2": "Goisp SSL is applying for the free version of TrustAsia DV SSL CA - G5 certificate, which only supports a single domain name application",
		...
		"ssl_tips6": "99% of users can easily deploy themselves, if you don't understand, <a class='btlink' href='https://www.goisp.net/yunwei' target='_blank'>Goisp offers Certificate deployment service 50 yuan once</a>",
		...
		"dns_check_tips3": "Before using the [Goisp DNS Cloud Resolution] interface, you need to confirm that the domain name DNS for which you want to apply for an SSL certificate is [Cloud Resolution]",
		...
		"dns_resolve_tips2": "The CMD command can be used to manually verify that the domain name resolution is in effect: nslookup -q=txt _acme-challenge.goisp.net",
		"dns_resolve_tips3": "If you are using the Goisp Cloud Resolution Plugin, Alibaba Cloud DNS, DnsPod as DNS, can be resolved automatically using the DNS interface",
	...
	"public_backup": {
		...
		"cp_fail": "Copy failed, browser is not compatible!",
		"bind_bt_account": "Bound Goisp official website account",
		...
		"cancel": "cancel",
		"unbind": "unbind",
		"open_bt_small_app": "Open the Goisp Panel applet",
		"app_qr_core": "applet QR code",
		"scan_qr_core": "Use the Goisp applet to scan the current QR code and bind the panel",
		"return_bind_list": "return panel binding list",
		"read_bind_list": "View Binding List",
		"bind_wechat": "Bind WeChat",
		...
		"year3": "3 years",
		"permanent": "permanent",
		"buy_multiplev_bt_pro": "Note: If you need to purchase multiple permanent licenses, please visit the official website of Goisp to buy.",
		"goto_bt": "Go to the Goisp official website",
	...
	"login": {
		"qr_core_login": "Goisp Widget Code Login",
		"open": "open",
		"bt_small_p": "Goisp applet",
	...
	"webhook": {
		...
		"read_key": "View key",
		"test": "Test",
		"use_method": "Goisp WebHook Usage:",
